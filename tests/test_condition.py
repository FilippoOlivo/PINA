...
#     input_lt, target_lt = _create_lt_data()
#     cond = Condition(input=input_lt, target=target_lt)
#     assert isinstance(cond, TensorInputTensorTargetCondition)

#     input_graph, target_graph = _create_graph_data()
...
#     # assert isinstance(cond, GraphInputGraphTargetCondition)
#     input_graph_lt, target_graph_lt = _create_graph_lt_data()
...
#     input_tensor, _ = _create_tensor_data()
#     input_graph, _ = _create_graph_data()
...
#     input_lt, _ = _create_lt_data()
#     input_graph_lt, _ = _create_graph_lt_data()
#     input_tensor, _ = _create_tensor_data()
#     input_graph, _ = _create_graph_data()
